            ...
            <form class="add-article-form">
                <div class="top-box">
                    <div class="left-sided">
                        ...
                        <div class="file-system file-upload-container">
                            <div class="file-upload-button">
                                <label for="file-system-upload">Select thumbnail</label>
                                <input id="file-system-upload" hidden type="file"/>
                            </div>
                            <div class="file-upload-current">
                                <div class="image-upload-view" x-px="1280"></div>
                                <div class="image-upload-preview-onhover">
                                    <div class="image"></div>
                                </div>
                ...
                <div class="wysiwyg-static-container">
                    <div class="wysiwyg-toolbar">
                        ...
                        <div class="wysiwyg-option list">
                            <ul style="scale: 0.4;position: relative;width: 100%;">
                                <li>List</li>
                                <li>List</li>
                                <li>List</li>
                            </ul>
